...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-time-slicer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15239&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-time-slicer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-time-slicer` can be installed with:

```
conda install napari-time-slicer
```

It is possible to list all of the versions of `napari-time-slicer` available on your platform with:
